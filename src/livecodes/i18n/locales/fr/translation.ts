...
const translation: I18nTranslation = {
  ...
  backup: {
    ...
    inProgress: 'En cours...',
    restore: {
      desc: "Restaurez les données LiveCodes précédemment sauvegardées. <1></tag-1> Si vous choisissez de remplacer le contenu actuel, vous voudrez peut-être d'abord le sauvegarder. <tag-2></tag-2> Pour plus de détails, veuillez consulter la <tag-3>documentation</tag-3>",
  ...
  broadcast: {
    ...
    desc: "Diffusez la page de résultat vers d'autres navigateurs et appareils en temps réel. Pour plus de détails, veuillez consulter la <1>documentation</tag-1>",
    error: {
  ...
  import: {
    bulk: {
      desc: "Importation groupée de plusieurs projets dans vos projets enregistrés. Les projets peuvent être exportés depuis l'écran <1>Projets Enregistrés</tag-1>",
